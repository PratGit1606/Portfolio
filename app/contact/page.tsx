...
import { Mail, Github, Linkedin, Terminal, Send, ArrowLeft, Copy, Check } from 'lucide-react';
            ...
            <div className="space-y-6">
              <div className="backdrop-blur-xl bg-white/[0.02] border border-white/10 rounded-lg p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="w-full group px-6 py-4 bg-[#F5C518] text-black font-mono text-sm uppercase tracking-wider hover:bg-[#F5C518]/90 transition-all duration-300 flex items-center justify-center gap-3 rounded"
                  >
